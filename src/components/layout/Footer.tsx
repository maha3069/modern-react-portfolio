...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/mahahajmeftah',
      icon: (
    ...
    {
      name: 'Email',
      url: 'mailto:hajmeftahmahat@gmail.com',
      icon: (
          ...
          <div className="footer__section">
            ...
            <div className="footer__contact">
              <p className="footer__contact-item">
                ...
                <a href="mailto:hajmeftahmaha@gmail.com" className="footer__contact-link">
                hajmeftahmaha@gmail.com
                </a>
              </p>
              <p className="footer__contact-item">
